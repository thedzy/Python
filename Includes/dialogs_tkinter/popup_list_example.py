...
def main():
    list_items = ['Amsterdam, Netherlands', 'Rotterdam, Netherlands', 'The Hague, Netherlands', 'Utrecht, Netherlands',
                  'Eindhoven, Netherlands', 'Tilburg, Netherlands', 'Groningen, Netherlands',
                  ...
                  'Oud-Beijerland, Netherlands', 'Wierden, Netherlands', 'Schijndel, Netherlands',
                  'Nuenen, Netherlands',
                  ...
                  'Stadskanaal, Netherlands', 'Cranendonck, Netherlands', 'Meerssen, Netherlands',
                  'Vianen, Netherlands',
                  ...
                  'Bergschenhoek, Netherlands', 'Eibergen, Netherlands', 'Asten, Netherlands',
                  'Lindenholt, Netherlands',
                  'Harlingen, Netherlands', 'Nederweert, Netherlands', 'Hoge Vucht, Netherlands',
                  'Westervoort, Netherlands', 'Harenkarspel, Netherlands', 'Staphorst, Netherlands',
                  'Nuth, Netherlands',
                  'Boskoop, Netherlands', 'Voorhout, Netherlands', 'Hilvarenbeek, Netherlands',
                  'Noordwijkerhout, Netherlands']

    answer, exit_code = PopupList('Cities', 'Please select your city?', list_items).get_input()
