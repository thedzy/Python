...
class Wifi():
	...
	def associateToEnterpriseNetwork_identity_username_password_error(self, ssid, identity, username, password, error=None):
	    """
	    ...
	    return CWInterface.interface().associateToEnterpriseNetwork_identity_username_password_error_(network, None, username, password, None)
	...
	def removeNetwork(self, *ssid):
	    ...
	    configuration_replcement = CWMutableConfiguration.alloc().initWithConfiguration_(CWInterface.interface().configuration())
