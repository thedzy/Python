...
"""
Script:	download_jss_configurationprofiles.py
Date:	2018-10-04
...
def main():
	...
	object_folder = os.path.dirname(os.path.realpath(__file__)) + '/ConfigurationProfiles/' + fmtdate
	...
	for object in objects:
		...
		script_file = open(object_folder + '/' + format_filename(object_name) + '.mobileconfig', 'wb')
		script_file.write(xml.dom.minidom.parseString(object_payload).toprettyxml().encode())
		script_file.close()
